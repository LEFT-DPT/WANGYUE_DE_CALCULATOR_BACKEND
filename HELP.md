...
* The following dependencies are not known to work with Spring Native: 'MS SQL Server Driver, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 wyc:0.0.1-SNAPSHOT
```
